...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        // UI feedback (instant: 80-100ms for perceived responsiveness)
        "accordion-down": "accordion-down 0.1s cubic-bezier(0.32, 0.72, 0, 1)",
        "accordion-up": "accordion-up 0.1s cubic-bezier(0.32, 0.72, 0, 1)",
        // Micro-interactions (100-150ms - fast but visible)  
        "number-pop": "number-pop 0.12s cubic-bezier(0.32, 0.72, 0, 1)",
        "success-pop": "success-pop 0.12s cubic-bezier(0.32, 0.72, 0, 1)",
        // Standard transitions (150-200ms - smooth and responsive)
        "fade-in": "fade-in 0.18s cubic-bezier(0.32, 0.72, 0, 1)",
        "scale-in": "scale-in 0.18s cubic-bezier(0.32, 0.72, 0, 1)",
        "page-enter": "page-enter 0.2s cubic-bezier(0.32, 0.72, 0, 1)",
        "page-exit": "page-exit 0.15s cubic-bezier(0.32, 0, 0.67, 0)",
        "count-up": "count-up 0.2s cubic-bezier(0.32, 0.72, 0, 1) forwards",
        // Smooth entrances (250-300ms for visual polish)
        "fade-in-up": "fade-in-up 0.28s cubic-bezier(0.32, 0.72, 0, 1)",
        "stagger-in": "stagger-in 0.25s cubic-bezier(0.32, 0.72, 0, 1) forwards",
        "tab-content-in": "tab-content-in 0.25s cubic-bezier(0.32, 0.72, 0, 1) forwards",
        "modal-bounce": "modal-bounce 0.3s cubic-bezier(0.34, 1.56, 0.64, 1)",
        "sheet-bounce": "sheet-bounce 0.3s cubic-bezier(0.34, 1.56, 0.64, 1)",
        // Complex/celebratory (400-500ms for impact)
        "bounce-in": "bounce-in 0.4s cubic-bezier(0.68, -0.55, 0.265, 1.55)",
        "celebration-bounce": "celebration-bounce 0.45s cubic-bezier(0.68, -0.55, 0.265, 1.55) forwards",
        "stat-pop": "stat-pop 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards",
        // Continuous animations (optimized durations for 60fps perception)
        "shimmer": "shimmer 4s linear infinite",
        "shimmer-soft": "shimmer-soft 10s linear infinite",
        "float": "float 4s ease-in-out infinite",
        "pulse": "pulse 2.5s cubic-bezier(0.4, 0, 0.6, 1) infinite",
        "bounce-slow": "float 2.5s ease-in-out infinite",
        "spin-slow": "spin-slow 2.5s linear infinite",
        "pulse-glow": "pulse-glow 2.5s ease-in-out infinite",
        "glow-pulse": "glow-pulse 2.5s ease-in-out infinite",
        "radar-sweep": "radar-sweep 2.5s linear infinite",
        "radar-blip": "radar-blip 2.5s ease-out infinite",
        "signal-wave": "signal-wave 2s ease-out infinite",
        // One-shot effects
        "confetti": "confetti 2s ease-out forwards",
        "wave-up": "wave-up 4s ease-out forwards",
        "ripple": "ripple 0.4s cubic-bezier(0.32, 0.72, 0, 1) forwards",
        "particle-burst": "particle-burst 0.8s ease-out forwards",
        "avatar-glow-pulse": "avatar-glow-pulse 0.4s ease-out",
        "float-up": "float-up 0.8s ease-out forwards",
        // Error/feedback animations
        "error-shake": "error-shake 0.35s cubic-bezier(0.36, 0.07, 0.19, 0.97)",
        "error-pulse": "error-pulse 0.5s ease-out",
        // Subtle continuous effects
        "wifi-pulse": "wifi-pulse 2.5s ease-in-out infinite",
        "sparkle": "sparkle 2s ease-in-out infinite",
        "gentle-pulse": "gentle-pulse 2.5s ease-in-out infinite",
        "sonar-ping": "sonar-ping 2.5s ease-out infinite",
      },
    },
  },
