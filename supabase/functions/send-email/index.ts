...
const emailRequestSchema = z.object({
  type: z.enum(['user_verification', 'password_reset', 'affiliate_verification', 'order_confirmation', 'affiliate_welcome', 'tier_upgrade', 'affiliate_tier_upgrade', 'claim_request', 'early_member_welcome', 'referral_welcome']),
...
interface EmailRequest {
  type: 'user_verification' | 'password_reset' | 'affiliate_verification' | 'order_confirmation' | 'affiliate_welcome' | 'tier_upgrade' | 'affiliate_tier_upgrade' | 'claim_request' | 'early_member_welcome' | 'referral_welcome';
  to: string;
  language?: string;
...
const generateEmailHTML = (type: string, data: any): { html: string; subject: string } => {
  ...
  switch (type) {
            ...
            <div style="background: linear-gradient(135deg, #0f172a 0%, #1e1b4b 50%, #0f172a 100%); padding: 40px 20px; border-radius: 12px;">
              ...
              <div style="background: rgba(16, 185, 129, 0.15); border: 1px solid rgba(16, 185, 129, 0.3); border-radius: 12px; padding: 20px; margin: 24px 0;">
                ...
                <p style="color: #cbd5e1; font-size: 14px; margin: 0; text-align: center; line-height: 1.6;">
                  Invite friends and earn <strong style="color: #10b981;">5% of all points</strong> they earn — forever!<br/>
    ...
    case 'referral_welcome':
      return {
        subject: "🎉 Welcome to Nomiqa! You've Been Referred by a Friend",
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: linear-gradient(180deg, #0f172a 0%, #1e293b 100%); padding: 40px 30px; border-radius: 16px;">
            <div style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.1); border-radius: 12px; padding: 30px;">
              <div style="text-align: center; margin-bottom: 30px;">
                <img src="${logoUrl}" alt="Nomiqa" style="width: 100px; height: 100px; border-radius: 20px; border: 2px solid #10b981; box-shadow: 0 4px 20px rgba(16, 185, 129, 0.4);" />
              </div>
              
              <div style="text-align: center; margin-bottom: 30px;">
                <span style="font-size: 48px;">🎉</span>
                <h1 style="color: #10b981; font-size: 28px; margin: 15px 0 5px 0; font-weight: 400;">Welcome to the Network!</h1>
                <p style="color: #e2e8f0; font-size: 16px; margin: 0;">You've been referred by <strong style="color: #22d3ee;">${data.referrerUsername || 'a friend'}</strong></p>
              </div>
              
              <div style="background: rgba(16, 185, 129, 0.1); border: 1px solid rgba(16, 185, 129, 0.3); border-radius: 12px; padding: 24px; margin: 24px 0;">
                <p style="color: #e2e8f0; font-size: 16px; line-height: 1.6; margin: 0; text-align: center;">
                  Congratulations! You've joined the world's first <span style="color: #10b981; font-weight: bold;">community-owned DePIN mobile network</span> through a special referral.
                </p>
              </div>
              
              <div style="margin: 30px 0;">
                <h2 style="color: #a78bfa; font-size: 18px; margin-bottom: 20px; font-weight: 400;">🌟 As a referred member, you get:</h2>
                <div style="space-y: 16px;">
                  <div style="display: flex; align-items: flex-start; margin-bottom: 16px;">
                    <span style="color: #10b981; margin-right: 12px; font-size: 18px;">✓</span>
                    <p style="color: #cbd5e1; margin: 0; font-size: 15px;"><strong>Early Member Status</strong> — Priority access to rewards</p>
                  </div>
                  <div style="display: flex; align-items: flex-start; margin-bottom: 16px;">
                    <span style="color: #10b981; margin-right: 12px; font-size: 18px;">✓</span>
                    <p style="color: #cbd5e1; margin: 0; font-size: 15px;"><strong>Earn Crypto</strong> — Contribute data & earn USDC/SOL</p>
                  </div>
                  <div style="display: flex; align-items: flex-start; margin-bottom: 16px;">
                    <span style="color: #10b981; margin-right: 12px; font-size: 18px;">✓</span>
                  ...
                  <div style="display: flex; align-items: flex-start; margin-bottom: 16px;">
                    <span style="color: #10b981; margin-right: 12px; font-size: 18px;">✓</span>
                    <p style="color: #cbd5e1; margin: 0; font-size: 15px;"><strong>Refer & Earn</strong> — Build your own network for bonus rewards</p>
                  </div>
                </div>
              </div>
              ...
              <div style="background: rgba(34, 211, 238, 0.1); border: 1px solid rgba(34, 211, 238, 0.3); border-radius: 12px; padding: 20px; margin: 24px 0; text-align: center;">
                <p style="color: #22d3ee; font-size: 15px; margin: 0 0 10px 0; font-weight: bold;">
                  💡 Pro Tip
                </p>
                <p style="color: #cbd5e1; font-size: 14px; margin: 0;">
                  Complete your profile and start referring friends to maximize your earning potential!
                </p>
              </div>
