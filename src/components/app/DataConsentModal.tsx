 ...
 * FULLSCREEN standalone overlay (portaled) so it never sits under PageTransition transforms.
 */
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            {/* Header */}
            <header
              className="shrink-0 bg-background/95 backdrop-blur-sm border-b border-border"
              style={{
            ...
            {/* Bottom action bar */}
            <div
              className="shrink-0 bg-background/95 backdrop-blur-sm border-t border-border z-20"
