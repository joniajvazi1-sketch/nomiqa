...
/**
 * How You Contribute Card - Explains the contribution mechanism in simple terms
...
export const HowYouEarnCard: React.FC<HowYouEarnCardProps> = ({
  ...
  const steps = [
    { icon: Smartphone, text: 'Switch to cellular to contribute', color: 'text-sky-400' },
    { icon: Zap, text: 'Points collected automatically', color: 'text-neon-cyan' },
    { icon: Gift, text: 'Rewards available at network launch', color: 'text-amber-400' },
  ];
      ...
      <div className={cn(
        ...
        <div className="flex-1 min-w-0">
          <p className="text-[10px] text-muted-foreground truncate">
            Use cellular • Data contributed automatically • Test phase
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div className={cn(
      ...
      <div className="flex items-center gap-2 mb-3">
        ...
        <div>
          <h3 className="text-sm font-semibold text-foreground">How You Contribute</h3>
      ...
      <div className="mt-3 pt-3 border-t border-white/[0.08]">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[10px] text-amber-200/70">
            Test phase – contributions tracked, rewards activate later
          </span>
        </div>
      </div>
    </div>
