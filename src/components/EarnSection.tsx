  ...
  return (
    <section className="py-20 bg-gradient-teal relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        ...
        <div className="absolute bottom-10 right-10 w-96 h-96 bg-nomiqa-orange rounded-full blur-3xl animate-float" style={{ animationDelay: "1s" }}></div>
      </div>
      ...
      <div className="absolute right-10 top-1/2 -translate-y-1/2 hidden xl:block">
        <img 
          ...
          className="w-64 h-64 object-contain animate-float opacity-80"
