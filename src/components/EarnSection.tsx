  ...
  return (
    <section className="py-20 bg-gradient-to-br from-nomiqa-orange/20 via-nomiqa-peach/30 to-nomiqa-orange/10 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-10 left-10 w-72 h-72 bg-nomiqa-orange rounded-full blur-3xl"></div>
        <div className="absolute bottom-10 right-10 w-96 h-96 bg-nomiqa-peach rounded-full blur-3xl"></div>
      </div>
