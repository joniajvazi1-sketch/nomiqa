  ...
  return (
    <section className="py-12 md:py-20 bg-gradient-to-br from-deep-space via-midnight-blue to-deep-space relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-20">
        ...
        <div className="absolute bottom-10 right-10 w-80 md:w-96 h-80 md:h-96 bg-neon-violet rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
      </div>
      ...
      <div className="container px-4 relative z-10">
        <div className="text-center max-w-4xl mx-auto animate-fade-in-up">
          ...
          <p className="text-sm md:text-base lg:text-lg mb-8 md:mb-12 text-neon-cyan/90 font-medium px-4">
            Lock NMQ tokens to earn free data credits and affiliate rewards. Your travel, powered by Web3.
          </p>
          
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-bounce-in px-4" style={{ animationDelay: "0.3s" }}>
            <Button 
              variant="neon" 
              size="lg"
