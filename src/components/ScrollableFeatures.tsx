  ...
  const features = [
    {
      ...
      highlights: [
        { text: "Beginner: 5% cashback", gradient: "from-amber-600 to-amber-800", icon: Trophy },
        { text: "Traveler: 6% cashback", gradient: "from-gray-400 to-gray-600", icon: Trophy },
        { text: "Adventurer: 7% cashback", gradient: "from-yellow-400 to-yellow-600", icon: Trophy },
        { text: "Explorer: 10% cashback", gradient: "from-purple-400 to-purple-600", icon: Trophy },
      ],
