...
export const Navbar = () => {
  ...
  return (
    <nav className="sticky top-0 left-0 right-0 z-50 bg-deep-space/95 backdrop-blur-xl border-b border-white/10 shadow-lg">
            ...
            <button onClick={() => navigate('/')} className="group flex items-center gap-2.5">
              <div className="relative">
                <img 
                  src={headerLogo} 
                  alt="Nomiqa" 
                  className="w-8 h-8 sm:w-9 sm:h-9 rounded-2xl object-cover transition-all duration-300 group-hover:scale-110 border border-white/20 group-hover:border-neon-cyan/40 shadow-lg group-hover:shadow-neon-cyan/30"
                />
              ...
              <Sheet open={desktopMenuOpen} onOpenChange={setDesktopMenuOpen}>
                ...
                <SheetContent side="right" className="w-[85vw] max-w-[380px] bg-deep-space/95 border-l border-white/20 shadow-2xl">
                  ...
                  <div className="flex flex-col gap-0.5 mt-6 relative z-10">
                    ...
                    <button onClick={() => handleNavClick('/privacy-policy')} className="group text-left text-white/60 hover:text-white/90 hover:bg-white/[0.05] transition-all duration-300 py-3 px-5 rounded-lg font-light text-sm tracking-wide border border-transparent hover:border-white/10">
