    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-deep-space to-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        <div className="max-w-6xl mx-auto">
          ...
          {/* Earnings Cascade Visualization */}
          <div className="max-w-4xl mx-auto mb-16">
            <Card className="border-2 border-primary/20 bg-gradient-to-br from-primary/5 to-accent/5">
              <CardContent className="p-8">
                <div className="text-center mb-8">
                  <h3 className="text-2xl md:text-3xl font-bold text-foreground mb-2">
                    See How One $50 Sale Multiplies
                  </h3>
                  <p className="text-warm-sand/80">Watch your earnings cascade through your network</p>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  {/* Arrow */}
                  <div className="flex justify-center animate-fade-in [animation-delay:300ms]">
                    <div className="text-neon-purple text-3xl">↓</div>
                  </div>

                  {/* Level 2 */}
                  <div className="animate-fade-in [animation-delay:600ms] flex items-center gap-4 p-4 bg-neon-purple/10 border-2 border-neon-purple/30 rounded-lg">
                  ...
                  {/* Level 3 */}
                  <div className="animate-fade-in [animation-delay:1200ms] flex items-center gap-4 p-4 bg-neon-cyan/10 border-2 border-neon-cyan/30 rounded-lg">
                  ...
                  {/* Total */}
                  <div className="animate-fade-in [animation-delay:1500ms] border-t-2 border-primary/20 pt-6 mt-6">
                    <div className="flex items-center justify-between p-6 bg-gradient-to-r from-neon-coral/20 via-neon-purple/20 to-neon-cyan/20 rounded-lg border-2 border-primary/30">
                      <div>
                        <p className="text-warm-sand/70 mb-1">Total from One Network Chain</p>
                        <p className="text-sm text-warm-sand/60">Without doing anything after the first referral</p>
                      </div>
                      <div className="text-right">
                        ...
                        <p className="text-sm text-warm-sand/70">18% total commission</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-6 text-center">
                  <p className="text-sm text-warm-sand/80 italic">
                    Now imagine 10, 50, or 100 network chains... 🚀
                  </p>
                </div>
              </CardContent>
            </Card>
