        ...
        <div className="pb-28" style={{ paddingTop: 'calc(env(safe-area-inset-top, 0px) + 8px)' }}>
          ...
          <header className="px-5 mb-4">
            <div className="flex items-center justify-between mb-3">
              <div>
                <p className="text-sm text-amber-600 dark:text-amber-400 font-medium">{greeting} 👋</p>
                <h1 className="text-2xl font-bold text-foreground">{displayName}</h1>
              </div>
              <div className="flex items-center gap-2">
                <button 
                  onClick={() => { lightTap(); setTheme(isDark ? 'light' : 'dark'); }}
                  className="w-10 h-10 rounded-full bg-amber-500/10 dark:bg-amber-500/20 flex items-center justify-center border border-amber-500/20"
                >
            ...
            {/* Points Display - Warm Card */}
            <motion.div 
              initial={{ opacity: 0, y: 8 }}
              animate={{ opacity: 1, y: 0 }}
              className="rounded-2xl bg-gradient-to-br from-amber-500/10 via-orange-500/5 to-transparent border border-amber-500/20 p-4"
            >
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs text-amber-700 dark:text-amber-400/80 font-medium mb-1">Your Earnings</p>
                  ...
                  {totalPoints > 0 && (
                    <p className="text-xs text-emerald-600 dark:text-emerald-400 mt-1">Keep it up! 🎉</p>
                  )}
                </div>
                <div className="flex gap-5">
                  ...
                  <div className="text-center">
                    <p className="text-[10px] text-muted-foreground uppercase tracking-wider mb-0.5">Team</p>
          ...
          <div className="px-5 mt-5 space-y-5">
            ...
            {/* Referral Section - Warm & Inviting */}
            <motion.div
              initial={{ opacity: 0, y: 12 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.1 }}
              className="rounded-3xl bg-gradient-to-br from-amber-500/10 via-orange-500/5 to-rose-500/5 border border-amber-500/20 p-5"
            >
              <div className="flex items-center gap-3 mb-4">
                <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-amber-500/20 to-orange-500/20 flex items-center justify-center border border-amber-500/30">
                  <Gift className="w-6 h-6 text-amber-600 dark:text-amber-400" />
                </div>
                <div className="flex-1">
                  <h3 className="text-base font-semibold text-foreground">Grow Together 🌱</h3>
                  <p className="text-sm text-muted-foreground">Invite friends & earn 5% of their points</p>
                </div>
              </div>

              {/* Referral Link Display */}
              <div className="bg-background/80 rounded-xl p-3 flex items-center gap-2 mb-4 border border-border/50">
              ...
              {referralCount > 0 && (
                <p className="text-center text-xs text-amber-700 dark:text-amber-400/80 mt-3">
            ...
            <motion.div
              ...
              className="rounded-3xl bg-gradient-to-br from-sky-500/5 via-blue-500/5 to-indigo-500/5 border border-sky-500/15 p-5"
            >
              <h3 className="text-base font-semibold text-foreground mb-1">How You Earn ✨</h3>
              <p className="text-xs text-muted-foreground mb-4">It's simple, passive, and rewarding</p>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 pt-0.5">
                    <p className="text-sm font-medium text-foreground">App runs quietly in background</p>
                    <p className="text-xs text-muted-foreground mt-0.5">Uses less than 3% battery daily — you won't even notice</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 pt-0.5">
                    <p className="text-sm font-medium text-foreground">Share anonymous network data</p>
                    <p className="text-xs text-muted-foreground mt-0.5">Help improve coverage for everyone, completely private</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 pt-0.5">
                    <p className="text-sm font-medium text-foreground">Watch your points grow</p>
                    <p className="text-xs text-muted-foreground mt-0.5">Redeem for real rewards whenever you're ready</p>
                  </div>
                </div>
              </div>
            </motion.div>
